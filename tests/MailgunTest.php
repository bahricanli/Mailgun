...
class MailgunTest extends MailgunTestCase
{
    ...
    {
        $provides = (new BahriCanli\Mailgun\MailgunServiceProvider($this->app))->provides();
        $this->assertEquals([
            'mailgun',
            'mailgun.public',
            BahriCanli\Mailgun\Contracts\Mailgun::class
        ], $provides);
    }
    ...
    public function it_registers_the_mailgun_service()
    {
        ...
        $this->assertInstanceOf(BahriCanli\Mailgun\Service::class, $service);
    }
    ...
    {
        $service = $this->app->make(BahriCanli\Mailgun\Contracts\Mailgun::class);
        $this->assertInstanceOf(BahriCanli\Mailgun\Service::class, $service);
    }
    ...
    {
        $this->assertInstanceOf(BahriCanli\Mailgun\Service::class, Mailgun::getFacadeRoot());
    }
