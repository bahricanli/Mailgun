...
namespace BahriCanli\Mailgun\Mail;

use BahriCanli\Mailgun\Http\Response;
use Carbon\Carbon;
use Closure;
...
class Mailer
{
     ...
     * @param null         $message
     *
     * @return \BahriCanli\Mailgun\Http\Response
     */
     ...
     *
     * @param \Closure                      $callback
     * @param \BahriCanli\Mailgun\Mail\Message $message
     *
     * @return mixed
     */
